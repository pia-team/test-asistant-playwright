@dcmuiv2 @e2e
Feature: Customer and User Management
  As a user, I want to manage customer and user data in the system.

  Scenario: Edit customer address, manage contacts, and update user details
    ...
    And I click "users"
    And I click "Edit button in users table row 2"
