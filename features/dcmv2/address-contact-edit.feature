@regression @smoke
Feature: Address Contact Edit
  As a user, I want to edit address and contact information for a customer to keep their records up-to-date.

  Scenario: Edit address and contact information for a customer
    ...
    And I click "users"
    And I click "Edit button in users-table-cell-2-actions"
