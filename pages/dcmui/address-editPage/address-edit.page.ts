  ...
  public async clickElement(elementIdentifier: string): Promise<void> {
    switch (elementIdentifier) {
      ...
      case 'ANGULARYIRMI INDIVIDUAL 2007/':
        await this.angularyirmiOption.waitFor({ state: 'visible', timeout: 8000 });
      ...
      case 'DEFAULT_BILLING_ADDRESS ASD':
        await this.defaultBillingAddressRowButton.waitFor({ state: 'visible', timeout: 10000 });
      ...
      case 'Address Line 2':
        ...
        break;
      case 'Country':
        await this.countryCombobox.waitFor({ state: 'visible', timeout: 8000 });
        await this.countryCombobox.click();
        break;
      case 'TURKEY':
        await this.turkeyOption.waitFor({ state: 'visible', timeout: 8000 });
