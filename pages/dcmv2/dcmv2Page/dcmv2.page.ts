...
export class Dcmv2Page {
  ...
  private readonly editButtonInUserTable: Locator;
  ...
  constructor(page: Page) {
    ...
    this.editButtonInUserTable = page.getByTestId('users-table-cell-2-actions').getByRole('button', { name: 'Edit' });
  ...
  public async clickElement(elementIdentifier: string): Promise<void> {
    switch (elementIdentifier) {
      ...
      case 'Edit button in users-table-cell-2-actions':
        await this.editButtonInUserTable.click();
        await this.page.waitForLoadState('networkidle', { timeout: 15000 }).catch(() => {});
